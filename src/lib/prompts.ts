...
3. У полі "Текст картинки" генеруй коротко і влучно. Тільки ті фрази, які реально будуть на креативі. Це не сценарій, це готовий текст для верстки.
...
Згенеруй текст розгорнуто (Хук, Біль, Рішення, CTA), як і для інших форматів картинок, щоб донести повну цінність продукту.
