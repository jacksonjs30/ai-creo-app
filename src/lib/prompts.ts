...
Креатив має виглядати як РЕАЛЬНА ФОТО РЕКЛАМА: реалістичне фото (сток або UGC стиль) з мінімальним, але сильним текстом поверх.
Текст картинки для Real-Photo Creo:
1 сильний хук (макс 7-9 слів).
1 підтримуючий рядок АБО вигода (макс 7-10 слів).
1 CTA рядок (2-4 слова).
Разом: максимум 3 рядки та 18-22 слова.
Ніяких довгих абзаців. Фото має нести 70% сенсу, текст лише загострює повідомлення та CTA.
