...
Це пряма конверсійна реклама продукту, без зайвих історій та метафор.
Текст картинки має СТРОГО складатися з 4-х блоків:
1. ГОЛОВНИЙ РЕЗУЛЬТАТ: Величезний заголовок (наприклад, "Керуй цифрами, а не проблемами").
2. БУЛІТИ (найважливіше): 3-4 коротких пункти (наприклад: "- Аналізуй цифри", "- Плануй майбутнє", "- Контролюй витрати").
3. ПРОДУКТ: Назва курсу/продукту + для кого він (коротко).
4. ЗНИЖКА/CTA: Велика плашка "Знижка -20%" + Кнопка "Дізнатися більше".

У "Брифі для дизайнера" для Прямого продажу:
Вкажи жорстку структурну верстку. Буліти з іконками (галочки, списки). Виділення найважливішого жовтим або яскравим кольором. Чітка кнопка внизу.
