...
🚨 МАКСИМАЛЬНА РІЗНОМАНІТНІСТЬ: Якщо замовлено декілька варіантів, кожен з них має бути АБСОЛЮТНО РІЗНИМ! КАТЕГОРИЧНО заборонено повторювати одні й ті самі хуки, фрази чи болі (наприклад, постійно використовувати "День бабака"). Використовуй різні кути підходу для кожного варіанту: 1-й про економію часу, 2-й про страх помилки, 3-й через гумор, 4-й про масштаб тощо. Ніколи не дублюй вступні фрази!
${params.colors ? `
...
ЯКЩО ФОРМАТ = КАРТИНКА (Текст на білому фоні, Фото + текст, Мем-крео, Інфографіка, Карусель, Реалістичне фото-крео (Real-Photo Creo))
✅ ЩО ГЕНЕРУЄМО:
...
3. У полі "Текст картинки" завжди генеруй КОРОТКО! Пиши від 3 до 5 коротких рядків (Хук, Біль/Вигода, Назва, CTA, Акція). Сумарно не більше 15–30 слів. Ніяких довгих текстів, тільки головне для креативу!
...
Фото-Сцена (Візуал): Обери ОДИН ключовий повсякденний момент із CJM. Опиши ХТО в кадрі, ЩО вони роблять, ДЕ вони, ЯКА ЕМОЦІЯ на обличчі.
...
Референс: 1-2 речення, яку емоцію повинен відчути глядач. Глядач має подумати: "Це буквально я".
