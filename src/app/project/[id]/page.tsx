    ...
    <div suppressHydrationWarning>
      ...
      {activeSection === 'integrations' && (
        <div className="card" style={{ padding: '3rem', textAlign: 'center' }}>
          ...
          <p style={{ color: 'var(--text-muted)', marginBottom: '2rem' }}>Здесь вы можете привязать свои рекламные кабинеты для автоматической выгрузки креативов.</p>
          ...
          <div style={{ display: 'flex', gap: '1rem', justifyContent: 'center' }}>
            ...
            >
              ...
              Подключить Facebook Ads
            </a>
            <button disabled className="btn btn-secondary" style={{ padding: '0.75rem 1.5rem', opacity: 0.5, cursor: 'not-allowed' }}>
              TikTok Ads (В разработке)
            </button>
          </div>
        </div>
      )}
